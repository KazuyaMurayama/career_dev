...
> **使い方:** 作業前にこのファイルを参照し、目的に合うファイルのパスを確認してください。

---

## ⚠️ 2026-04-17 重要インシデント（要把握）

2026-04-17 に Git ブランチ整理中、誤って以下の全作業ブランチをリモート削除しました:
- `claude/japanese-confirmation-KoaZO`（主要作業ブランチ）
- `claude/analyze-freelance-income-3EGdc`（分析・計画ブランチ）
- `claude/analyze-career-freelance-PCQl5`（生成スクリプト）
- `claude/check-repo-file-lists-desRY`（税務並行）
- `claude/analyze-career-freelance-Fqa1L`（アーカイブ）
- `claude/git-operation-rules-20Ivw`（Git操作ルール追加）

**その後、Claude Code が他セッション履歴や残存 docx から主要ファイルを main に復旧**。現在の運用は **main ブランチ一本** に集約されています（作業ブランチは使用しない）。

詳細は [CLAUDE.md](https://github.com/KazuyaMurayama/career_dev/blob/main/CLAUDE.md) の改訂履歴参照。
...
| ブランチ名 | 役割・作成目的 | 状態 |
|---|---|---|
| `main` | **唯一の運用ブランチ**。全ファイル・ルール・インデックスを保持 | ✅ 稼働中 |

> **注:** 2026-04-17 のインシデント以降、作業ブランチは廃止。全作業は `main` で実施します（詳細は [CLAUDE.md](https://github.com/KazuyaMurayama/career_dev/blob/main/CLAUDE.md) 参照）。
...
| **ポジショニングを確認する** | [positioning_strategy.md](https://github.com/KazuyaMurayama/career_dev/blob/main/positioning_strategy.md) |
| **市場相場・競合を確認する** | [market_research_step1.md](https://github.com/KazuyaMurayama/career_dev/blob/main/market_research_step1.md) |
| **収入パターンの実現性を確認する** | [feasibility_scoring.md](https://github.com/KazuyaMurayama/career_dev/blob/main/feasibility_scoring.md) |
| **税務手続きチェックリスト** | [tax_procedures_checklist.md](https://github.com/KazuyaMurayama/career_dev/blob/main/tax_procedures_checklist.md) |
| **前回セッションの振り返り** | [session_summary_20260407.md](https://github.com/KazuyaMurayama/career_dev/blob/main/session_summary_20260407.md) |
| **次アクション・引き継ぎタスクを確認する** | [tasks.md](https://github.com/KazuyaMurayama/career_dev/blob/main/tasks.md) |
| **INTLOOP の契約書（NDA/業務委託）** | [【INT】秘密保持契約書（20250210版）.docx](https://github.com/KazuyaMurayama/career_dev/blob/main/%E3%80%90INT%E3%80%91%E7%A7%98%E5%AF%86%E4%BF%9D%E6%8C%81%E5%A5%91%E7%B4%84%E6%9B%B8%EF%BC%8820250210%E7%89%88%EF%BC%89.docx) / [業務委託契約書（IC・一人法人用）20250210 Ver2.docx](https://github.com/KazuyaMurayama/career_dev/blob/main/%E6%A5%AD%E5%8B%99%E5%A7%94%E8%A8%97%E5%A5%91%E7%B4%84%E6%9B%B8%EF%BC%88IC%E3%83%BB%E4%B8%80%E4%BA%BA%E6%B3%95%E4%BA%BA%E7%94%A8%EF%BC%8920250210%20Ver2.docx) |
| [positioning_strategy.md](https://github.com/KazuyaMurayama/career_dev/blob/main/positioning_strategy.md) | MD | **ポジショニング戦略**（4象限分析・Tier分類・差別化） |
...
## 🔴 2026-04-17 インシデントで喪失したファイル（未復旧）

以下のファイルは _file_index.md の過去版に記載がありましたが、ブランチ削除により現在は復旧困難です。v5最新版があれば実用上は問題ありません。

### スキルシート旧版（v1〜v4）

| バージョン | ファイル名 | 日付 | 状態 |
|---|---|---|---|
| v1 | `skill_sheet_updated.md/docx/pdf` | 2026/3〜4初旬 | 🔴 喪失 |
| v2 | `Oza_skill_sheet_20260403.docx/pdf` | 2026/4/3 | 🔴 喪失 |
| v3 | `Oza_skill_sheet_20260406-3.docx` | 2026/4/6 | 🔴 喪失 |
| v4 | `Oza_skill_sheet_20260409.docx/md` | 2026/4/9 | 🔴 喪失 |

### 職務経歴書旧版

| バージョン | ファイル名 | 日付 | 状態 |
|---|---|---|---|
| v1〜v3 | `Oza_Career_sheet_20260406-1/2/3.docx` | 2026/4/6 | 🔴 喪失 |
| v4 | `Oza_Career_sheet_20260407-1.docx` | 2026/4/7 | 🔴 喪失 |

### その他欠落（未復旧、重要度 Medium 以下）
...
| バージョン | ファイル名 | 日付 | 主な変更 |
|---|---|---|---|
| 原本 | [Skill Sheet 男座員也 202601.docx](https://github.com/KazuyaMurayama/career_dev/blob/main/Skill%20Sheet%20%E7%94%B7%E5%BA%A7%E5%93%A1%E4%B9%9F%20202601.docx) | 2026年1月 | 原本 |
| v1〜v4 | （旧版） | 2026/3〜4/9 | 🔴 2026-04-17 インシデントで喪失 |
| v5 | [Oza_skill_sheet_20260414.docx](https://github.com/KazuyaMurayama/career_dev/blob/main/Oza_skill_sheet_20260414.docx) / [.md](https://github.com/KazuyaMurayama/career_dev/blob/main/Oza_skill_sheet_20260414.md) | 2026/4/14 | セキュリティ・ガバナンス追加、レイアウト最適化（3ページ収納） |
| **v6（最新）** | [Oza_skill_sheet_20260417.docx](https://github.com/KazuyaMurayama/career_dev/blob/main/Oza_skill_sheet_20260417.docx) / [.md](https://github.com/KazuyaMurayama/career_dev/blob/main/Oza_skill_sheet_20260417.md) | 2026/4/17 | 職務経歴書と整合（在籍期間・役職名・研修受講者数） |
...
1. **新規ファイル追加時**: 該当セクションに追記、最終更新日を更新
2. **ファイル削除・廃止時**: 該当行を削除 or 「（アーカイブ）」マーク追加
3. **最新版マーカー（★）**: 新しい最新版ができたら、前の「★」を外し新しい方に付ける
4. **バージョン履歴**: 大きな変更はバージョン履歴テーブルに追記
5. **運用ブランチ**: **main 一本のみ**。作業ブランチは作成しない（詳細 [CLAUDE.md](https://github.com/KazuyaMurayama/career_dev/blob/main/CLAUDE.md)）
